...
export const getAdminPromotions = (params) => {
  return apiClient.get("/api/admin/promotions/listPromotions", { params });
};

export const getAdminPromotionById = (id) => {
  return apiClient.get(`/api/admin/promotions/getPromotionById/${id}`);
};

export const createAdminPromotion = (promotionData) => {
  return apiClient.post("/api/admin/promotions/addPromotions", promotionData);
};

export const updateAdminPromotion = (id, promotionData) => {
  return apiClient.put(`/api/admin/promotions/updatePromotions/${id}`, promotionData);
};

export const deleteAdminPromotion = (id) => {
  return apiClient.delete(`/api/admin/promotions/deletePromotions/${id}`);
};
// export const toggleAdminPromotionStatus = (id, isActive) => {
//   return apiClient.put(`/api/admin/promotions/toggleStatus/${id}`, { isActive });
// };
export const toggleAdminPromotionStatus = (id, isActive) => {
  return apiClient.patch(`/api/admin/promotions/toggleStatus/${id}?isActive=${isActive}`);
};
